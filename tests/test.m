...
fprintf('If you do not see a "success" message in the end of the script, it means there is an error\n');
fprintf('***********************************\n');
fprintf('***********************************\n');
...
fprintf('\n3) Testing getKeggPkas() - using ChemAxon script\n')
...
fprintf('\n4) Testing getGroupVectorFromInchi() - the group decomposition Python script\n')
